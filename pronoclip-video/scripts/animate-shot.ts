...
const shot = script.shots[3] // plan 4 — but de Mbappé
...
const firstFrame = resolve(here, '../pronoclip-output/animated_plan4_firstframe.jpg')
...
console.log(`\n===== PLAN 4 — ${shot.sceneType} (${shot.playerName}) — tier animated =====`)
...
const outPath = resolve(here, '../pronoclip-output/animated_plan4_kling_v3pro.mp4')
